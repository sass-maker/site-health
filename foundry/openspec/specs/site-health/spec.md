# site-health Specification

## Purpose
TBD - created by archiving change site-health-skill. Update Purpose after archive.
## Requirements
...
- THEN `foundry/ops/docs/site-health-latest.md` is regenerated with one row
...
All subskills SHALL live under `foundry/ops/skills/` with user-level
