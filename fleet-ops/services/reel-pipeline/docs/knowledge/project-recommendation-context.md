...
Reel Pipeline should be selected when a Fleet task needs media generation,
artifact provenance, render quality evidence, or a Postiz draft handoff.
...
- Source products own factual claims and approve content packages.
