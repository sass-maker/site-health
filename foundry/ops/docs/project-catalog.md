...
| --- | --- | ---: | ---: | --- | --- | --- | --- | --- |
| CodeVetter | active | yes | yes | The seven-product Hub and preserved Live landing are deployed and publicly verified. (verified 2026-08-21) | `codevetter` | cloudflare pages `codevetter` (git-connected; live)<br>cloudflare worker `codevetter-landing-proxy` (legacy-worker; live-retained) | cloudflare zone `codevetter.com` (active-config-derived) | 2026-08-11 |
