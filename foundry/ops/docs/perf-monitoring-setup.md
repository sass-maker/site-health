...
Template: `foundry/ops/templates/api-timing.ts`
...
|----------|---|
| ❌ Missing | saas-maker, free-ai, reader, looptv, aliveville |
...
| PSI sweep | psi-swarm | foundry/ops/scripts | Weekly (GHA) |
...
- **API timing:** copy `foundry/ops/templates/api-timing.ts` to `src/lib/api-timing.ts`, call `initApiTiming()`
