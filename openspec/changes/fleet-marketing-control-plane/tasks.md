...
- [ ] 1.1 Add the versioned marketing program registry for every active Fleet project
- [ ] 1.2 Add schema validation, canonical slug/alias uniqueness checks, and focus-set invariants
- [ ] 1.3 Align the domain marketing plan and queue-builder priorities with the registry
...
- [ ] 4.4 Add Postiz fixture/contract evaluation without installing it or connecting accounts
