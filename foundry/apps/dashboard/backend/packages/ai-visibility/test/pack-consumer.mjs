...
writeFileSync(
  ...
  JSON.stringify({ type: "module", dependencies: { "@dashboard/ai-visibility": `file:./${archive}` } }),
);
writeFileSync(
...
writeFileSync(
  ...
  [
    'import { analyzeMentionResponse, type BrandSubject } from "@dashboard/ai-visibility";',
