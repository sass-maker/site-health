...
- **WHEN** repository evidence is green but deployment or smoke evidence is
  absent
...
feedback, usage/outcome, and release evidence without treating missing
...
- **THEN** Foundry creates a recommendation linking the release, affected
  prompts/providers, confidence, and suggested investigation
...
- **THEN** Foundry records measured results, baseline, attribution caveats, and
  a continue/stop/change recommendation without automatically launching the
  next experiment
