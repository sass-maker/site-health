...
- Attention: unclassified 179
- Inventory sources: unknown 179
...
| [agent-testing](./agent-testing.yaml) | CI | `.github/workflows/ci.yml` | — | — | pull_request, push | — | unverified | unverified | unverified | — | — |
...
| [browserdaddy](./browserdaddy.yaml) | CI | `.github/workflows/ci.yml` | — | — | pull_request, push | — | unverified | unverified | unverified | — | — |
...
| [nomad-data-adventure](./nomad-data-adventure.yaml) | Static product checks | `.github/workflows/ci.yml` | — | — | pull_request, push | — | unverified | unverified | unverified | — | — |
...
| [performancedaddy](./performancedaddy.yaml) | CI | `.github/workflows/ci.yml` | — | — | pull_request, push | — | unverified | unverified | unverified | — | — |
| [ph-catalog](./ph-catalog.yaml) | Daily Product Hunt refresh | `.github/workflows/daily.yml` | — | — | schedule, workflow_dispatch | 47 21 * * * | unverified | unverified | unverified | — | — |
...
| [shoulders](./shoulders.yaml) | Validate static site | `.github/workflows/ci.yml` | — | — | pull_request, push | — | unverified | unverified | unverified | — | — |
...
| [storagedaddy](./storagedaddy.yaml) | CI | `.github/workflows/ci.yml` | — | — | pull_request, push | — | unverified | unverified | unverified | — | — |
...
| [unified-portfolio](./unified-portfolio.yaml) | CI | `.github/workflows/ci.yml` | — | — | pull_request, push | — | unverified | unverified | unverified | — | — |
...
| [ph-catalog](./ph-catalog.yaml) | Daily Product Hunt refresh | 47 21 * * * | — | — | — |
