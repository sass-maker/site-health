...
| Devin (`devin --model glm-5.2`) | `call-devin` | Optional proprietary autonomous teammate for expensive external attempts | ACU/spend + vendor lock-in; use only with explicit approval | ✅ CLI smoke-tested 2026-07-12; REST adapter credentials pending |
