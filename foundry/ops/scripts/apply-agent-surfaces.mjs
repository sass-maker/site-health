...
const PUBLISHER_IMAGE = 'https://avatars.githubusercontent.com/u/43884471?v=4';
const PUBLISHER_JOB_TITLE = 'AI Infrastructure & Product Engineer';
...
const PUBLISHER_AFFILIATION = {
  '@type': 'Organization',
  '@id': 'https://sassmaker.com/#app',
  name: 'SaaS Maker',
...
function buildJsonLd(product, registry) {
  ...
  const publisherNode = {
    ...
    '@id': PUBLISHER_ID,
    name: PUBLISHER_NAME,
    jobTitle: PUBLISHER_JOB_TITLE,
    url: PUBLISHER_URL,
    image: PUBLISHER_IMAGE,
    sameAs: PUBLISHER_SAME_AS,
    knowsAbout: PUBLISHER_KNOWS_ABOUT,
    affiliation: PUBLISHER_AFFILIATION,
  };
