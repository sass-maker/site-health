...
|---|---|---|
| "can AI crawlers read it", llms.txt, GEO surfaces | agent-ready | `foundry/ops/skills/agent-ready/` |
| "check meta/canonical/schema", on-page SEO | seo-audit | `foundry/ops/skills/seo-audit/` |
| "is it fast", CWV, Lighthouse | psi-swarm | `foundry/ops/skills/psi-swarm/` → canonical `foundry/ops/psi-swarm/SKILL.md` |
| "did results move", SERP trend, weekly run | geo-observatory | `foundry/ops/skills/geo-observatory/` |
...
3. Emit `foundry/ops/docs/site-health-latest.md`: one row per product —
...
- Per user directive (2026-07-17): `foundry/ops/skills/` is the ONLY home —
  ...
  skill joins `foundry/ops/skills/psi-swarm/` as a relative symlink to its
  canonical `foundry/ops/psi-swarm/SKILL.md`.
