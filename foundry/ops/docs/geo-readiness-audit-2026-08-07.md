...
| Drank | PASS — https://domains.sassmaker.com | PASS — internal `foundry/helpers/drank` | PARTIAL — landing only | NOT APPLICABLE | MISSING | Add a focused public methodology page, then capture provider observations. |
...
| PSI Swarm | PASS — https://performance.sassmaker.com | PASS — internal `foundry/helpers/psi-swarm` | PARTIAL — landing only | NOT APPLICABLE | MISSING | Add a focused public methodology page, then capture provider observations. |
