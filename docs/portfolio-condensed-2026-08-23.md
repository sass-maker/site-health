...
| Every Song Is a Website (`every-song-is-a-website`) | Active | Give each famous song its own curated interactive visual world — a playful gallery, not a streaming product. | Live at music.significanthobbies.com as a static Workers-assets deploy; 111 songs across three themes with YouTube and Genius embeds. | Maintain the catalog and worlds; add themes or songs only on explicit request. |
