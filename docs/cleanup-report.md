...
| Project tasks | The 54-repository scan at 10:44:49Z found 43 open issues, zero PRs and every issue referenced in its README. Later repairs and new findings change these counts; this snapshot is not a completed-task claim. Publication drafts and unfinished requirements remain open. |
...
Reader account PDF notes, Knowledge Base shared-document isolation and Anchor
account-scoped sync. Keep every unfinished requirement actionable in its owning
