...
Date: 2026-08-23 (lifecycle counts and explicit removals reconciled 2026-09-20)
Scope: all 69 retained canonical identities; archived identities remain recorded for infrastructure ownership but are excluded from Fleet listings.
...
| Active | 29 | Supported and kept useful; improvements follow concrete needs. |
| Inactive | 38 | No planned development or autonomous expansion. Preserve relevant software, data and evidence. |
| **Total** | **69** | Every canonical Fleet identity appears exactly once. |
...
| BrowserDaddy (`browserdaddy`) | Active | Build a local-first Mac archive of browsing history and attention across browsers. | Artwork-only Editorial landing live at browserdaddy.significanthobbies.com; native app remains a private development preview without a public download. | Follow indexing outcomes after accepted sitemap/IndexNow submission; qualify native privacy and distribution separately. |
...
| Every Song Is a Website (`every-song-is-a-website`) | Active | Give each famous song its own curated interactive visual world — a playful gallery, not a streaming product. | Live at music.significanthobbies.com as a static Workers-assets deploy; 143 songs across three themes, 32 of them pulled from the owner's Apple Music library with YouTube and Genius embeds. | Maintain the catalog and worlds; add themes or songs only on explicit request. |
...
| PerformanceDaddy (`performancedaddy`) | Active | Investigate local Mac performance through visible processes, ports, resource measurements, and reviewed actions. | Editorial landing live at performancedaddy.significanthobbies.com; native app remains a local preview without a public download. | Follow indexing outcomes after accepted sitemap/IndexNow submission; qualify native distribution separately. |
