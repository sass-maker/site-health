...
const GLOBAL_DATA_BASE =
  ...
  'https://raw.githubusercontent.com/sass-maker/fleet-workspace/main/foundry/apps/internal/drank/data';
        ...
        {!belowFold ? (
          ...
          <>
            ...
            <div className="mt-10 text-center text-[11px] text-white/40">
              ...
              <span className="text-white/20"> · </span>
              <a
                href="https://github.com/sass-maker/fleet-workspace/tree/main/foundry/apps/internal/drank"
                className="underline text-white/30 hover:text-white/50"
              >
                source
              </a>
