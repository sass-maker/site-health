# evidence-activity-ledger Specification

## Purpose

Define Foundry's append-only activity and evidence ledger, idempotency,
provider ownership, projection rebuild, privacy, and freshness contracts.
