...
const fleetRoot = resolve(appRoot, "../..");
...
export function getDomainIntelligence(): DomainIntelligence[] {
  const drank = readJsonObject(resolve(fleetRoot, "services/drank/data/fleet-dr.json")) as {
...
export function getMarketingPipeline(): MarketingPipeline {
  const pipelineRoot = resolve(fleetRoot, "services/reel-pipeline");
