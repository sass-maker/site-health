...
> Canonical source: `foundry/apps/dashboard/mobile-cockpit/` in
...
Mobile Dev Cockpit is an experimental, local-only mobile client for Fleet
Console. It is not a public application, and its long-term product future has
not been decided.
