...
| Indulge | active | yes | yes | The owner approved the verified product and trust site for public sharing; no App Store, TestFlight, or native distribution claim is approved. (verified 2026-08-16) | `induldge` | cloudflare pages `indulge` (wrangler-direct; live)<br>apple app-store-connect `Indulge` (manual-xcode; blocked-on-app-record) | — | 2026-08-11 |
