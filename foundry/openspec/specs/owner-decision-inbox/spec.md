# owner-decision-inbox Specification

## Purpose

Define Foundry's persistent, typed, reversible, deduplicated owner-decision
boundary without expanding authority or becoming another task tracker.
...
- **THEN** Foundry updates the existing item's evidence or freshness rather
  than creating duplicate owner work
