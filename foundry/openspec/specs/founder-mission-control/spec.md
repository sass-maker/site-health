# founder-mission-control Specification

## Purpose

Define Foundry's canonical owner objectives, missions, intake, actor state,
owner-first views, evidence-backed completion, schedules, and summaries.
...
changed, and Recommended next rather than infrastructure inventory.
...
- **THEN** the summary reports decisions needed, active work, completed
  outcomes, material changes, and failed or stale schedules without raw logs
