...
```bash
node fleet-ops/skills/public-product-smoke/scripts/build-audit-manifest.mjs
node fleet-ops/skills/public-product-smoke/scripts/build-audit-manifest.mjs \
...
The helper reads `fleet-ops/config/projects.json` plus the root `AGENTS.md`
...
- `fleet-ops/docs/public-product-smoke-latest.md`
- `fleet-ops/docs/public-product-smoke-latest.json`
