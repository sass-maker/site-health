...
| BrowserDaddy (`browserdaddy`) | Active | Build a local-first Mac archive of browsing history and attention across browsers. | Public 0.3.1 build 9, first-install download, GitHub release, and signed Sparkle feed are live; an earlier isolated build 4-to-6 update and native journey passed. | Continue native privacy qualification and verify future updates from older public builds. |
...
| PerformanceDaddy (`performancedaddy`) | Active | Investigate local Mac performance through visible processes, ports, resource measurements, and reviewed actions. | Public 0.2.3 build 8, first-install download, GitHub release, and signed Sparkle feed are live; an earlier isolated build 3-to-5 update and native journey passed. | Use measured evidence before acting on a diagnosis; keep the landing and native release claims distinct. |
...
| StorageDaddy (`storagedaddy`) | Active | Build a native Mac storage analyzer with reviewed cleanup. | Public 0.1.3 build 110 and signed Sparkle feed are live; an earlier isolated build 106-to-108 update and native scan passed. | Continue measuring scan correctness and runtime efficiency before expanding scope. |
