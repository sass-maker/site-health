...
4. Re-audit: `node foundry/ops/skills/agent-ready/scripts/agent-index-audit.mjs --all`.
...
# On-page SEO
bash foundry/ops/skills/seo-audit/scripts/seo-audit.sh https://rolepatch.com/ --site https://rolepatch.com
...
node foundry/ops/scripts/apply-agent-surfaces.mjs --jsonld --dry-run    # preview
node foundry/ops/scripts/apply-agent-surfaces.mjs --jsonld              # inject
node foundry/ops/scripts/apply-agent-surfaces.mjs --jsonld-emit         # emit snippets for JSX layouts

# IndexNow (Bing/Yandex/etc. — not Google). See docs/indexnow.md
node foundry/ops/scripts/indexnow-submit.mjs --init-key
node foundry/ops/scripts/indexnow-submit.mjs --apply-keys   # then deploy
