...
writeFileSync(
  ...
  JSON.stringify({ type: "module", dependencies: { "@saas-maker/ai-visibility": `file:./${archive}` } }),
);
writeFileSync(
...
writeFileSync(
  ...
  [
    'import { analyzeMentionResponse, type BrandSubject } from "@saas-maker/ai-visibility";',
