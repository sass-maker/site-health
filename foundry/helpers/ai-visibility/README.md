...
An internal Fleet helper library for provider-independent execution and
analysis of AI mentions, recommendations, ranking, sentiment, citations,
competitors, personas, share of voice, and visibility trends.

The helper keeps a typed package boundary for its consumers, but it is not a
public Fleet package. It is headless and does not import a web framework, database client,
