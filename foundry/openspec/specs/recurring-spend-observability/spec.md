# recurring-spend-observability Specification

## Purpose

Define Fleet's operator-controlled, read-only weekly observation of Cloudflare
and Turso spend, quota pressure, and evidence gaps without recording secrets or
