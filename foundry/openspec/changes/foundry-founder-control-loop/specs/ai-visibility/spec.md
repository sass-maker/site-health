...
The package SHALL normalize citations and compute per-provider,
per-persona, competitor share-of-voice, visibility, recommendation, and ranking
aggregates from completed results.
