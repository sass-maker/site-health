...
```bash
foundry/ops/scripts/agent-bin/fleet-notify emit \
...
foundry/ops/scripts/agent-bin/fleet-notify status
foundry/ops/scripts/agent-bin/fleet-notify list --limit 20
foundry/ops/scripts/agent-bin/fleet-notification-service start
```
