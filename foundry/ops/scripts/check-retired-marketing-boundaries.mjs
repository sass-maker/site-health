...
const retiredPaths = [
  ...
  'foundry/services/reel-pipeline/src/saas-maker-client.js',
  'foundry/services/reel-pipeline/src/autopilot.js',
  'foundry/services/reel-pipeline/src/posting.js',
  'foundry/services/reel-pipeline/reel/src/saas_maker.rs',
  'foundry/services/reel-pipeline/reel/src/autopilot.rs',
  'foundry/services/reel-pipeline/reel/src/marketing_posting.rs',
];
const runtimeRoots = [
  'foundry/apps/ops-console/src',
  'foundry/ops/scripts/agent-bin',
  'foundry/services/reel-pipeline/src',
  'foundry/services/reel-pipeline/scripts',
  'foundry/services/reel-pipeline/reel/src',
];
const forbidden = [
