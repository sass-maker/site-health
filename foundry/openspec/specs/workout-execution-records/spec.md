# workout-execution-records Specification

## Purpose
Define how Setline keeps immutable programme intent separate from detailed
session execution, cadence, and history.
