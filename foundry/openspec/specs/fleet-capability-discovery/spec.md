# fleet-capability-discovery Specification

## Purpose

Define one read-only discovery contract for canonical Fleet operational
capabilities so humans and agents can find and inspect existing tools without
maintaining a duplicated registry.
