...
| Reproducibility | 1/4 | 4/4 | `design-workflow.json` pins Impeccable 3.9.1; agent-stack installation repairs drift; self-check and regression tests verify the pin |
...
- Detector heuristics remain useful signals without becoming an aesthetic
  authority.
- Fresh machines and existing machines use the same upstream skill version.
