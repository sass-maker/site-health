...
- [x] 1. Move psi-swarm's skill to `fleet-ops/skills/psi-swarm/` (copied from the
...
- [x] 2. Author `fleet-ops/skills/site-health/SKILL.md` — routing table +
      combined-mode protocol; frontmatter description covering all child
      trigger phrases (≤60 lines total).
- [x] 3. `fleet-ops/scripts/site-health-scorecard.mjs` — aggregate
