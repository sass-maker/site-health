...
It is a Fleet helper under `foundry/helpers/`. The helper owns its runtime,
domain logic, and canonical `SKILL.md`; `foundry/ops/skills/psi-swarm/SKILL.md`
is only a symlinked invocation entrypoint. Do not duplicate helper
implementation in the Fleet skill layer.
