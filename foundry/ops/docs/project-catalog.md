...
Provider inventory checked 2026-08-21. A resource is not considered accounted for unless it is assigned to a project or listed under unowned resources.
...
| --- | --- | ---: | ---: | --- |
| pages | provider-complete | 31 | 33 | Wrangler account list plus verified direct uploads through 2026-08-21: 31 live after adding Journal and Habits, plus the restored SaaS Maker package-docs target and one deleted historical target. |
...
| --- | --- | ---: | ---: | --- | --- | --- | --- | --- |
| CodeVetter | active | yes | yes | Verified active, deployed, live canonical public surface with a maintained listing. (verified 2026-08-11) | `codevetter` | cloudflare pages `codevetter` (git-connected; live)<br>cloudflare worker `codevetter-landing-proxy` (legacy-worker; live-retained) | cloudflare zone `codevetter.com` (active-config-derived) | 2026-08-11 |
...
| Significant Hobbies | active | yes | yes | The seven-product Hub and preserved Live landing are deployed and publicly verified. (verified 2026-08-21) | `significanthobbies` | cloudflare worker `significanthobbies` (wrangler-direct; live) | cloudflare d1 `significanthobbies` (active)<br>cloudflare d1 `significanthobbies-preview` (preview)<br>cloudflare workers-ai `AI` (active)<br>cloudflare zone `significanthobbies.com` (active-config-derived)<br>turso database `significanthobbies` (rollback-held-unverified) | 2026-08-21 |
...
| Setline | active | yes | no | Landing is live at setline.significanthobbies.com from the ios-landings factory. Not ready to share: no public TestFlight or App Store build is approved. (verified 2026-08-17) | `setline` | cloudflare pages `setline` (wrangler-direct; live) | — | 2026-08-17 |
| Kith | active | yes | no | Landing is live at kith.significanthobbies.com from the ios-landings factory. Not ready to share: no public TestFlight or App Store build is approved. (verified 2026-08-17) | `kith` | cloudflare pages `kith` (wrangler-direct; live) | — | 2026-08-17 |
...
| Habits | active | yes | no | Habits is live at habits.significanthobbies.com; the renamed native app is not released. (verified 2026-08-21) | `induldge` | cloudflare pages `habits` (wrangler-direct; live)<br>cloudflare pages `indulge` (wrangler-direct; live-compatibility)<br>apple app-store-connect `Indulge` (manual-xcode; blocked-on-app-record) | — | 2026-08-21 |
...
| Project | Status | Deployed | Ready to share | Readiness evidence | Repository | Deployment | Cloud resources | Updated |
| --- | --- | ---: | ---: | --- | --- | --- | --- | --- |
| Mashup | active | no | no | No usable distributed or provider-hosted surface is deployed, and the owner cut Mashup from the current SEO/GEO campaign. (verified 2026-08-16) | `mashup` | — | — | 2026-08-11 |
| Local AI Video Studio | active | yes | yes | The owner approved the verified maintained informational site for public sharing; no downloadable app, signed binary, or public release channel is approved. (verified 2026-08-16) | `local-ai-video-studio` | cloudflare pages `local-ai-video-studio` (wrangler-direct; live)<br>local macos-app `LocalVideoStudio` (swift-build; local-only) | — | 2026-08-11 |
...
| Project | Status | Deployed | Ready to share | Readiness evidence | Repository | Deployment | Cloud resources | Updated |
| --- | --- | ---: | ---: | --- | --- | --- | --- | --- |
| Mobile Dev Cockpit | archived | yes | no | The product is parked with no approved distribution; its retained Worker and container are inventory only. (verified 2026-08-20) | `mobile-dev-cockpit` | cloudflare worker `saasmaker-droid` (legacy-worker; live-retained) | cloudflare container `saasmaker-droid-sandbox` (retained) | 2026-08-20 |
...
| Chess | archived | yes | no | Archived at the owner's request; the live surface is retained but is no longer an active sharing target. (verified 2026-08-20) | `../fleet-inactive-projects/chess` | cloudflare pages `chess-9a0` (wrangler-direct; live) | — | 2026-08-11 |
