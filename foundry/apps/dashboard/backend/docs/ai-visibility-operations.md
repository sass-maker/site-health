...
```bash
node foundry/apps/dashboard/backend/scripts/ai-visibility-canary.mjs \
  --project pace \
  --fixture foundry/apps/dashboard/backend/test/fixtures/ai-visibility/providers-v1.json
```
...
```bash
node foundry/apps/dashboard/backend/scripts/ai-visibility-provider-observations.mjs \
