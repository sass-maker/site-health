...
- `npm run smoke:render-modes` — pass with local mock, HTML, ASCII, Grok-asset, Blender, and contract checks.
...
- Checkout-backed MoneyPrinterTurbo and reel-maker modes were removed on 2026-08-01; current policies use repository-owned render paths.
