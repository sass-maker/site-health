...
- [x] 1. Extract shared registry helpers to `foundry/ops/scripts/lib/registry.mjs`
...
- [x] 7. opennext products: emit `foundry/ops/out/jsonld/<id>.html` snippets;
      insert into each Next layout by hand; commit per repo.
- [x] 8. Add reported `jsonld` check to agent-index-audit.mjs; run `--all`.
- [x] 9. Docs: one section in `foundry/ops/docs/agent-indexing-standard.md`
