...
const retiredPaths = [
  ...
  'services/reel-pipeline/src/saas-maker-client.js',
  'services/reel-pipeline/src/autopilot.js',
  'services/reel-pipeline/src/posting.js',
  'services/reel-pipeline/reel/src/saas_maker.rs',
  'services/reel-pipeline/reel/src/autopilot.rs',
  'services/reel-pipeline/reel/src/marketing_posting.rs',
];
const runtimeRoots = [
  'apps/ops-console/src',
  'fleet-ops/scripts/agent-bin',
  'services/reel-pipeline/src',
  'services/reel-pipeline/scripts',
  'services/reel-pipeline/reel/src',
];
const forbidden = [
