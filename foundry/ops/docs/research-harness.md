...
```bash
./foundry/ops/scripts/agent-bin/harness-health
./foundry/ops/scripts/agent-stack.sh install-skills
./foundry/ops/scripts/agent-stack.sh install-agents
./foundry/ops/scripts/agent-stack.sh resume
./foundry/ops/scripts/agent-bin/mobile-control needs
./foundry/ops/scripts/agent-bin/mobile-control configure-telegram
./foundry/ops/scripts/agent-bin/mobile-control ping
./foundry/ops/scripts/agent-bin/research-dispatch "Compare options for ..."
./foundry/ops/scripts/agent-bin/grok-research-review "Challenge report ..."
```
