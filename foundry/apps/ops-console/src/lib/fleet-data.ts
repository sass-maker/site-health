...
const localDirBySlug: Record<string, string> = {
  ...
  drank: "foundry/services/drank",
  "fleet-ops": "foundry/ops",
  "reel-pipeline": "foundry/services/reel-pipeline"
};
...
export function getDomainIntelligence(): DomainIntelligence[] {
  const drank = readJsonObject(resolve(fleetRoot, "foundry/services/drank/data/fleet-dr.json")) as {
...
export function getMarketingPipeline(): MarketingPipeline {
  const pipelineRoot = resolve(fleetRoot, "foundry/services/reel-pipeline");
