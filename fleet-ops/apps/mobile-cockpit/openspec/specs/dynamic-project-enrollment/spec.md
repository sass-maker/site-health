# dynamic-project-enrollment Specification

## Purpose

Define how the bridge safely discovers repositories inside locally approved roots, presents bridge-owned command candidates for explicit review, and persists dynamic project enrollment without exposing arbitrary machine paths or weakening runtime approval gates.
