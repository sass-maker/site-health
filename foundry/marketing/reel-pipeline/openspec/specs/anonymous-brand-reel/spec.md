# anonymous-brand-reel Specification

## Purpose

Define the anonymous, no-account path from a public brand website to a reviewed,
presenter-led vertical reel while keeping website intake, presenter provenance,
artifact access, and the product boundary safe.
