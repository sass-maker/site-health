...
probes the canonical domains in `foundry/ops/config/projects.json`. It never
...
Exceptions belong in `foundry/ops/config/projects.json` or the relevant project
