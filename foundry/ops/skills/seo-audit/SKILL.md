...
```bash
bash foundry/ops/skills/seo-audit/scripts/seo-audit.sh <url>
```

Example:

```bash
bash foundry/ops/skills/seo-audit/scripts/seo-audit.sh https://vaultwealth.com/
```

### Multiple URLs (file, one per line)

```bash
bash foundry/ops/skills/seo-audit/scripts/seo-audit.sh <url-file>
```
...
EOF
bash foundry/ops/skills/seo-audit/scripts/seo-audit.sh /tmp/vault-urls.txt
```
...
```bash
bash foundry/ops/skills/seo-audit/scripts/seo-audit.sh https://vaultwealth.com/ --site https://vaultwealth.com
```
