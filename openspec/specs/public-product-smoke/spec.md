# public-product-smoke Specification

## Purpose

Define a repeatable, read-only Fleet audit that exercises a bounded set of
meaningful public product journeys and produces reproducible repair handoffs.
