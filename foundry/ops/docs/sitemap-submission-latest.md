...
| --- | --- | --- | ---: | --- | --- |
| CodeVetter | `codevetter.com` | Submit | 7 | ready | [https://codevetter.com/sitemap.xml](https://codevetter.com/sitemap.xml) |
| HeyPace | `heypace.app` | Submit | 21 | ready | [https://heypace.app/sitemap.xml](https://heypace.app/sitemap.xml) |
| PostTrainLLM | `posttrainllm.com` | Submit | 319 | ready | [https://posttrainllm.com/sitemap.xml](https://posttrainllm.com/sitemap.xml) |
...
| Email Manager | `mail.significanthobbies.com` | Submit | 0 | wrong-host | [https://mail.significanthobbies.com/sitemap.xml](https://mail.significanthobbies.com/sitemap.xml) |
...
| SWE Interview Prep | `learn.significanthobbies.com` | Submit | 308 | ready | [https://learn.significanthobbies.com/sitemap.xml](https://learn.significanthobbies.com/sitemap.xml) |
| Calorie | `calorie.significanthobbies.com` | Submit | 0 | not-xml | [https://calorie.significanthobbies.com/sitemap.xml](https://calorie.significanthobbies.com/sitemap.xml) |
| Setline | `setline.significanthobbies.com` | Submit | 0 | http-404 | [https://setline.significanthobbies.com/sitemap.xml](https://setline.significanthobbies.com/sitemap.xml) |
| RolePatch | `rolepatch.com` | Submit | 20 | ready | [https://rolepatch.com/sitemap.xml](https://rolepatch.com/sitemap.xml) |
| Karte | `karte.cc` | Submit | 0 | error | [https://karte.cc/sitemap.xml](https://karte.cc/sitemap.xml) |
| Starboard | `starboard.codevetter.com` | Submit | 36 | ready | [https://starboard.codevetter.com/sitemap.xml](https://starboard.codevetter.com/sitemap.xml) |
| App Health | `health.sassmaker.com` | Submit | 0 | not-xml | [https://health.sassmaker.com/sitemap.xml](https://health.sassmaker.com/sitemap.xml) |
...
- **health.sassmaker.com** — not-xml: application HTML or non-XML response
